from .models import ContactUser, ContactAdmin
...
class ContactUserForm(forms.Form):
    ...
    contact_subject = forms.CharField(max_length=50, label='', widget=forms.TextInput(attrs={
        'placeholder': 'Subject ',
        'class': 'form-control   ',
    }))
    contact_message = forms.CharField(max_length=200, label='', widget=forms.Textarea(attrs={
        'placeholder': ' Content ',
